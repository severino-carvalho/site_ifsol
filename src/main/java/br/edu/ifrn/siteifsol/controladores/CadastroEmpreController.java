...
public class CadastroEmpreController {
	...
	public String salvar(empreendimento empre,@RequestParam("file") MultipartFile arquivo, Model model, RedirectAttributes attr, HttpSession sessao) {
		...
		/*
		 * O CODIGO A SEGUIR FOI FEITO PARA UPLOAD  E DOWNLOAD DE UM ARQUIVO NO BANCO DE DADOS
		 * E O TRY FOI NECESSARIO PARA CASO OCORRA UM ERRO SEJA LANÇADO UMA EXCECAO
		 * 
		 */
    ...
    /*
	 * O AUTOCOMPLETE SERVE PARA RECEBER A LISTA DE PROFISSOES CONTIDA NO BANCO DE DADOS
	 * E QUANDO O USUARIO DIGITAR ELE DAR SUGESTÕES DE COMPLEMENTO DO SE ESTA SENDO DIGITADO
	 */
	...
	/*
	 * METODO DE VALIDAÇÃO DOS CAMPOS NOME,EMAIL,SENHA E SITUAÇÃO DO FORMULARIO DE CADASTRO,
